...
namespace Pharmacy_Management_System.Controllers
{
    ...
    public class EmailProcessController : ControllerBase
    {
        ...
        public IActionResult EmailSending(List<Order> data_table)
        {
            ...
            textBody += " <table border=" + 1 + " cellpadding=" + 0 + " cellspacing=" + 0 + " width = " + 400 + "><tr bgcolor='white'><td><b>Drug Name</b></td> <td> <b> Drug Quantity</b> </td> <td> <b> Unit Price</b> </td> <td> <b>Total Amount</b> </td></tr>";
